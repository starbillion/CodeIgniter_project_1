...
<div id="page-container" class="sidebar-l side-scroll header-navbar-fixed">
                            ...
                            <div class="col-lg-4">
                                <form action="<?= base_url() ?>payment" method="post">
                                    <ul class="plan plan7 featured">
                                        <li class="plan-name">
                                            <?= !empty($planData->subscription_name) ? $planData->subscription_name : '' ?>
                                        </li>
                                        <li class="plan-price">
                                            <h3><span class="currency_sign">£ </span><span
                                                        class="export_price"><?= !empty($planData->subscription_amount) ? $planData->subscription_amount : '' ?></span><span
                                                        class="price-month">/month</span></h3>

                                            <button type="submit" Class="btn bg-success">Pay</button>

                                        </li>

                                    </ul>
                                    <input type="hidden" name="amount"
                                           value="<?= !empty($planData->subscription_amount) ? $planData->subscription_amount : '' ?>">
                                    <input type="hidden" name="plan_name"
                                           value="<?= !empty($planData->subscription_name) ? $planData->subscription_name : '' ?>">
                                    <input type="hidden" name="plan_id"
                                           value="<?= !empty($planData->id) ? $planData->id : '' ?>">
                                </form>
                            </div>
                        <?php
                        }
    ...
    <footer id="page-footer" class="bg-body font-s12">
        <div class="content-mini content-mini-full content-boxed clearfix push-15">
            ...
            <div class="pull-left">
                <a class="font-w600" href="http://www.ibrinfotech.com/" target="_blank">IBR INFOTECH</a> © <span
                        class="js-year-copy">2014-17</span>
            </div>
        </div>
    </footer>
    <!-- END Footer -->
