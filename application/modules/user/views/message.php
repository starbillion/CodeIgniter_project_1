...
<div id="page-container" class="sidebar-l side-scroll header-navbar-fixed">
            ...
            <!-- Main Container -->
            <main id="main-container" style="min-height: 200px;text-align: center;">
                ...
                <?php if($this->session->flashdata("messagePr")){?>
                          ...
                          <h2 class="label-success"     style="margin-top: 15%;padding: 30px;""> Please Wait for Admin Approval</h2>
            </main>
            <!-- END Main Container -->
