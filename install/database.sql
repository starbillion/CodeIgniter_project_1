...
CREATE TABLE `drivers_licensing` (
  `drivers_licensing_id` int(121) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(255) DEFAULT NULL,
  `drivers_licensing_license` varchar(255) DEFAULT NULL,
  `drivers_licensing_upload_drivers_pco_doc` varchar(255) DEFAULT NULL,
  `drivers_licensing_upload_driver_insurance_doc` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`drivers_licensing_id`)
...
CREATE TABLE `enter_username_and_password` (
  `enter_username_and_password_id` int(121) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(255) DEFAULT NULL,
  `enter_username_and_password_username` varchar(255) DEFAULT NULL,
  `enter_username_and_password_password` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`enter_username_and_password_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
("1","admin","{\"user\":{\"own_create\":\"1\",\"own_read\":\"1\",\"own_update\":\"1\",\"own_delete\":\"1\",\"all_create\":\"1\",\"all_read\":\"1\",\"all_update\":\"1\",\"all_delete\":\"1\"},\"personal_details\":\"personal_details\",\"vehicle_details\":\"vehicle_details\",\"drivers_licensing\":\"drivers_licensing\",\"enter_username_and_password\":\"enter_username_and_password\"}");




CREATE TABLE `personal_details` (
  `personal_details_id` int(121) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(255) DEFAULT NULL,
  `personal_details_name` varchar(255) DEFAULT NULL,
  `personal_details_address` text,
  `personal_details_telephone` varchar(255) DEFAULT NULL,
  `personal_details_mobile_number` varchar(255) DEFAULT NULL,
  `personal_details_email` varchar(255) DEFAULT NULL,
  `personal_details_upload_photo` varchar(255) DEFAULT NULL,
...
("11","crud_list","users,User,personal details,vehicle details,Drivers licensing,Enter Username and Password"),
("12","EMAIL",""),
("13","UserModules","yes"),
("14","register_allowed","0"),
("15","email_invitation","0"),
("16","admin_approval","0"),
("17","user_type","[\"user\"]");
...
("1","1","admin","demo_pic.png","admin_email","admin_password","admin","0","active","","2017-05-17");




CREATE TABLE `vehicle_details` (
  `vehicle_details_id` int(121) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(255) DEFAULT NULL,
  `vehicle_details_model` varchar(255) DEFAULT NULL,
  `vehicle_details_make` varchar(255) DEFAULT NULL,
  `vehicle_details_registration` varchar(255) DEFAULT NULL,
  `vehicle_details_upload_doc` varchar(255) DEFAULT NULL,
